    ...
    for (int __or_block_step = 0; __or_block_step < __or_inner_steps; ++__or_block_step) {
        ...
        if (__or_kernel_item_count > 0) {
            ...
            q.submit([&](sycl::handler& h) {
                ...
                h.parallel_for<class __dacpp_sycl_kernel___dacpp_mpi_or_waveEqShell_waveEq_0_run_resident_spatial_kernel>(sycl::range<1>(static_cast<std::size_t>(__or_kernel_item_count)), [=](sycl::id<1> idx) {
